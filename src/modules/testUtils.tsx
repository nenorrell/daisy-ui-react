import { BaselessVariant, NoBaseOrNeutralVariant, StatusVariant, Variant } from "../@types/Colors";
...
export const NoBaseOrNeutralVariantOptions :NoBaseOrNeutralVariant[] = BaselessVariantOptions.filter(v=> v!== "neutral");
